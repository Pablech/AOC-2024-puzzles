...
One
 of The Historians needs to use the bathroom; fortunately, you know
...
or vertically) don't count as being in any quadrant, so the only
relevant robots are:
...
In this example, the quadrants contain `1`, `3`, `4`, and `1` robot. Multiplying these together gives a total *safety factor* of `<em>12</em>`.
...
During
 the bathroom break, someone notices that these robots seem awfully
similar to ones built and used at the North Pole. If they're the same
type of robots, they should have a hard-coded Easter egg: very rarely, most of the robots should arrange themselves into  *a picture of a Christmas tree* .
